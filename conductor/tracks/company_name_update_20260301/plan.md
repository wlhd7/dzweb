...
- [ ] Task: 编写测试用例，验证各语言版本下公司名称的输出
- [ ] Task: 更新 `dzweb/translations/en/LC_MESSAGES/messages.po` 对应条目
- [ ] Task: 更新 `dzweb/translations/ja/LC_MESSAGES/messages.po` 对应条目
- [ ] Task: 编译翻译文件 (`pybabel compile -d dzweb/translations`)
